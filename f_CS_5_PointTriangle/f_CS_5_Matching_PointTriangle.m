function [ OrderedMatchingResults ] = f_CS_5_Matching_PointTriangle( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
...
%             end
% 
%             [csfeature1] = f_CS_5_Feature_PointTriangle(sampoint1);
%             [csfeature2] = f_CS_5_Feature_PointTriangle(sampoint2);
