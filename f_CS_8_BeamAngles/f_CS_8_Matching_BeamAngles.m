function [ OrderedMatchingResults ] = f_CS_8_Matching_BeamAngles( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
...
%         end
% 
%         [csfeature1] = f_CS_8_Feature_BeamAngles(sampoint1);
%         [csfeature2] = f_CS_8_Feature_BeamAngles(sampoint2);
