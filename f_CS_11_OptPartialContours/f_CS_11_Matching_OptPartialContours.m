function [ OrderedMatchingResults ] = f_CS_11_Matching_OptPartialContours( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
...
%         end
% 
%         [csfeature1] = f_CS_11_Feature_OptPartialContours(sampoint1);
%         [csfeature2] = f_CS_11_Feature_OptPartialContours(sampoint2);
