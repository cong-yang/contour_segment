...
for i = 1:N
    ...
    [csfeature] = f_CS_6_Feature_ContourContext(pointlist);
    fullfeatures{i} = csfeature;
end
T_Feature = toc;
save('resources/T_Feature_ContourContext.mat','T_Feature');
%%
%time for retrieval
...
save('resources/QueryDTWContourContext.mat','QueryDTW');
...
save('resources/QueryDPContourContext.mat','QueryDP');
...
save('resources/QueryHungarianContourContext.mat','QueryHungarian');
