function [ curvatures ] = f_get_curvatures( ContourSegments )
%f_get_curvatures: this functions is used to generate curvatures for every 
%points in the contour segment

% %
% x = ContourSegments(:, 2);
% y = ContourSegments(:, 1);
% windowSize = length(x)/5;
...
% curvatures(abs(curvatures) > windowSize*2) = 0;
% 
