function [ csfeature ] = f_CS_16_Feature_Complexity( ContourSegment )
%f_CS_16_Feature_Complexity: this function is used to generate contour
%                            segment descriptor using Height functions.
%   input: 
%         ContourSegment: a single contour segment
%   output:
%          csfeature: the contour segment feature using height functions.
%   description:
%          refer to the paper: 
...
addi1 = 0;
for i = 1:M
    tmp1 = csfeature(i,:); % get row data from feature1
