function [ OrderedMatchingResults ] = f_CS_17_Matching_ChordDistributions( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
...
%         end
% 
%         [csfeature1] = f_CS_17_Feature_ChordDistributions(sampoint1);
%         [csfeature2] = f_CS_17_Feature_ChordDistributions(sampoint2);
