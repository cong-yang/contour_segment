function [ Corresponding, Similarity ] = f_Hungarian_Corresponding( CostMatrix )
%f_Hungarian_Corresponding: to find coresponding points based on 
%Cost Matrix
%   input: cost matrix
%   output: 
%          Corresponding: corresponding points
%          Similarity: similarity between two objects
