function [ OrderedMatchingResults ] = f_CS_3_Matching_HeightFunction( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
...
for i = 1:mylength
    ...
    if mylength == 1400 %only work for MPEG7
        ...
        [csfeature1] = f_CS_3_Feature_HeightFunction(sampoint1);
        [csfeature2] = f_CS_3_Feature_HeightFunction(sampoint2);
    end
