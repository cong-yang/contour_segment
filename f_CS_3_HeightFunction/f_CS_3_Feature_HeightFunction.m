function [ csfeature ] = f_CS_3_Feature_HeightFunction( ContourSegment )
%f_CS_3_Feature_HeightFunction: this function is used to generate contour
%                               segment descriptor using height function.
%   input: 
%         ContourSegment:  Nx2 matrix, input N contour segment points
%   output:
%          csfeature: the contour segment feature using height function
%   description:
%          refer to the paper: 
