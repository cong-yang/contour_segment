function [ OrderedMatchingResults ] = f_CS_7_Matching_TurningAngles( pointlist1, alldata, filetype, foldername, sampercen, match, fullfeatures )
%f_CS_7_Matching_TurningAngles: do the matching with matrix algorithm and output the 
%                               ranked final result
%   input:
