function [ OrderedMatchingResults ] = f_CS_10_Matching_ContourFlexibility( pointlist1, alldata, filetype, foldername, sampercen, fullfeatures )
...
for i = 1:mylength
    ...
    if mylength == 1400 %only work for MPEG7
        ...
        [csfeature1] = f_CS_10_Feature_ContourFlexibility(sampoint1);
        [csfeature2] = f_CS_10_Feature_ContourFlexibility(sampoint2);
    end
    
    [similarity] = f_CS_10_Similarity_ContourFlexibility(csfeature1, csfeature2);
